...
- [x] **2.3 Wire the Laggard Screen (J7)**
...
- [x] **2.4 Wire PEAD Calendar Trigger (`before-go-live/NEW-pead-calendar-trigger.md`)**
...
- [x] **2.5 Missing UI Badges (`before-go-live/NEW-ui-badges.md`)**
...
- [x] **2.6 Implement Portfolio Drawdown Protocol**
...
- [x] **2.7 Decide on the SOS Button (`SOS-button.md`)**
