...
# Used for UI search/autocomplete: Ticker (Name)
TICKER_NAMES = {
    'APC.DE':  'Apple',
    'MSF.DE':  'Microsoft',
    'AMZ.DE':  'Amazon',
    ...
    'INZ.DE':  'Intel',
    'QCI.DE':  'QCOM',
    'ASQ.DE':  'Applied Materials',
    'MTH.DE':  'Micron',
    'TNA.DE':  'Texas Instruments',
    'ORC.DE':  'Oracle',
    'TSFA.DE': 'TSMC',
    '6N0.DE':  'ServiceNow',
    '6SN.DE':  'Snowflake',
    ...
    'M9Z.DE':  'Mastercard',
    'CMC.DE':  'JPMorgan',
    'NCB.DE':  'Bank of America',
    'GOS.DE':  'Goldman Sachs',
    'M9N.DE':  'Morgan Stanley',
    'BRYN.DE': 'Berkshire Hathaway',
    'AEC.DE':  'American Express',
    'BLA.DE':  'BlackRock',
    'SAP.DE':  'SAP',
    'ALV.DE':  'Allianz',
    'SIE.DE':  'Siemens',
    ...
    'SPPW.DE': 'SPDR MSCI World',
    'IS3N.DE': 'iShares Core EM IMI',
